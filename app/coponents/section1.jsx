    ...
    <div className='h-screen w-86 flex flex-col items-center justify-between '>
      ...
      <div className='bg-[#101010] overflow-hidden mb-3 sm:mb-0 relative border border-[#141414] w-full h-[231px] rounded-lg'>
        ...
        <div className='w-full h-[80px] relative'>
          ...
          <div className='w-full h-[83px] px-2 mt-8 flex items-center justify-between '>
          <Image
          width={90}
          height={70}
          alt='project img'
        ...
        <Link href="/Projects">
        <button className='h-[40px] cursor-pointer w-[200px] z-10 rounded-md bg-[#773dff] text-white absolute top-15 left-[70px] '>View Works</button>
        </Link>
        </div>
      ...
      {/* about */}
      <div className=' relative bg-[#101010] border mb-3 sm:mb-0 border-[#141414] w-full h-[231px] rounded-lg flex flex-col items-center justify-center '>
      ...
      {/* resume section */}
       <div className='bg-[#101010] overflow-hidden mb-3 sm:mb-0 relative border border-[#141414] w-full h-[231px] rounded-lg'>
        ...
        {/* resume img section */}
        <div className='w-full h-[80px] relative top-4.5'>
        ...
        <button className='h-[40px] w-[200px] z-10 rounded-md bg-[#773dff] text-white absolute top-15 left-[70px] flex items-center justify-center '>
